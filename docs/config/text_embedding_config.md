...
!!! example "all-mpnet-base-v2"
    ...
    ```yaml title="gfmrag_hybrid/workflow/config/text_emb_model/mpnet.yaml"
    --8<-- "gfmrag_hybrid/workflow/config/text_emb_model/mpnet.yaml"
    ```

!!! example "BAAI/bge-large-en"

    ```yaml title="gfmrag_hybrid/workflow/config/text_emb_model/bge_large_en.yaml"
    --8<-- "gfmrag_hybrid/workflow/config/text_emb_model/bge_large_en.yaml"
    ```
  |       Parameter       |                  Options                  |                                       Note                                        |
  | :-------------------: | :---------------------------------------: | :-------------------------------------------------------------------------------: |
  |      `_target_`       | `gfmrag_hybrid.text_emb_models.BaseTextEmbModel` | The class name of [Text Embedding model][gfmrag_hybrid.text_emb_models.BaseTextEmbModel] |
...
!!! example "nvidia/NV-Embed-v2"
    ...
    ```yaml title="gfmrag_hybrid/workflow/config/text_emb_model/nv_embed_v2.yaml"
    --8<-- "gfmrag_hybrid/workflow/config/text_emb_model/nv_embed_v2.yaml"
    ```
