...
!!! example
    ...
    ```yaml title="gfmrag_hybrid/workflow/config/openie_model/llm_openie_model.yaml"
    --8<-- "gfmrag_hybrid/workflow/config/openie_model/llm_openie_model.yaml"
    ```


|      Parameter       |                             Options                             |                                           Note                                           |
| :------------------: | :-------------------------------------------------------------: | :--------------------------------------------------------------------------------------: |
|      `_target_`      |                              None                               | The class name of [LLM OpenIE model][gfmrag_hybrid.kg_construction.openie_model.LLMOPENIEModel] |
...
Please refer to [LLMOPENIEModel][gfmrag_hybrid.kg_construction.openie_model.LLMOPENIEModel] for more details of the other parameters.
