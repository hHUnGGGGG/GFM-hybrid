...
!!! example "colbertv2.0"
    ...
    ```yaml title="gfmrag_hybrid/workflow/config/el_model/colbert_el_model.yaml"
    --8<-- "gfmrag_hybrid/workflow/config/el_model/colbert_el_model.yaml"
    ```

|      Parameter      |                           Options                            |                                               Note                                               |
| :-----------------: | :----------------------------------------------------------: | :----------------------------------------------------------------------------------------------: |
|     `_target_`      | `gfmrag_hybrid.kg_construction.entity_linking_model.ColbertELModel` | The class name of [Colbert EL model][gfmrag_hybrid.kg_construction.entity_linking_model.ColbertELModel] |
...
Please refer to [ColbertELModel][gfmrag_hybrid.kg_construction.entity_linking_model.ColbertELModel] for details on the other parameters.
...
!!! example "DPR EL Model"
    ...
    ```yaml title="gfmrag_hybrid/workflow/config/el_model/dpr_el_model.yaml"
    --8<-- "gfmrag_hybrid/workflow/config/el_model/dpr_el_model.yaml"
    ```


|     Parameter      |                         Options                          |                                                       Note                                                       |
| :----------------: | :------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------: |
|     `_target_`     | `gfmrag_hybrid.kg_construction.entity_linking_model.DPRELModel` | The class name of [Dense Pre-train Text Embedding model][gfmrag_hybrid.kg_construction.entity_linking_model.DPRELModel] |
...
Please refer to [DPR EL Model][gfmrag_hybrid.kg_construction.entity_linking_model.DPRELModel] for details on the other parameters.
...
!!! example "nvidia/NV-Embed-v2"
    ...
    ```yaml title="gfmrag_hybrid/workflow/config/el_model/nv_embed_v2.yaml"
    --8<-- "gfmrag_hybrid/workflow/config/el_model/nv_embed_v2.yaml"
    ```

|     Parameter      |                                                   Options                                                   |                                                   Note                                                   |
| :----------------: | :---------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------: |
|     `_target_`     |                       `gfmrag_hybrid.kg_construction.entity_linking_model.NVEmbedV2ELModel`                        | The class name of [Nvidia Embedding model][gfmrag_hybrid.kg_construction.entity_linking_model.NVEmbedV2ELModel] |
...
Please refer to [NVEmbedV2 EL Model][gfmrag_hybrid.kg_construction.entity_linking_model.NVEmbedV2ELModel] for details on the other parameters.
