...
from gfmrag_hybrid.kg_construction.utils import KG_DELIMITER, processing_phrases
...
class KGConstructor(BaseKGConstructor):
    ...
    def get_document2entities(self, data_root: str, data_name: str) -> dict:
        ...
        with open(os.path.join(self.tmp_dir, "passage_info.json"), "r", encoding='utf-8') as fin:
    ...
    def open_ie_extraction(self, raw_path: str) -> str:
        ...
        """
        # Read data corpus
        with open(os.path.join(raw_path, "dataset_corpus.json"), encoding='utf-8') as f:
            corpus = json.load(f)
            if self.add_title:
                corpus = {
        ...
        if os.path.exists(open_ie_result_path):
            ...
            with open(open_ie_result_path, "r", encoding="utf-8") as f:
                for line in f:
    ...
    def create_graph(self, open_ie_result_path: str) -> dict:
        ...
        with open(os.path.join(self.tmp_dir, "passage_info.json"), "w", encoding='utf-8') as f:
